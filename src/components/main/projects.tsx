      ...
      <div className="projects">
        <div className="project">
          <div className="project--header">
            ...
            <div className="project--link">Link? You're already here!</div>
        ...
        <div className="project">
          <div className="project--header">
            <div className="project--name">Yeezus inspiration</div>
            <div className="project--link">
              <a
                href="https://yeebible.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="project--link">
              <a
                href="https://github.com/matbatten/Yeezus"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div>GitHub Repo</div>
